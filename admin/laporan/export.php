...
if ($format === 'excel') {
    ...
    $spreadsheet->getProperties()
        ->setCreator('SMK Yadika Jambi Absensi System')
        ->setLastModifiedBy('SMK Yadika Jambi Admin')
        ->setTitle($title)
        ->setSubject('Attendance Report')
        ->setDescription('Attendance report generated by SMK Yadika Jambi Absensi System');
    ...
    $sheet->setCellValue('A2', 'SMK YADIKA JAMBI');
    ...
    // Add footer
    $row += 2;
    $sheet->setCellValue('A' . $row, 'Laporan ini digenerate secara otomatis dari Sistem Absensi SMK Yadika Jambi');
    $sheet->mergeCells('A' . $row . ':G' . $row);
    ...
    $logoPath = $_SERVER['DOCUMENT_ROOT'] . '/c:/xampp/htdocs/Web-Absensi/assets/default/logo_yadika.png';
    ...
    <body>
        <div class="header">
            <div class="header-content">
                <img class="logo" src="' . $logoData . '" alt="SMKN 40 Jakarta">
                <div class="header-text">
                    <h1>LAPORAN ABSENSI SISWA</h1>
                    <h2>SMK YADIKA JAMBI</h2>
                </div>
            </div>
        </div>
